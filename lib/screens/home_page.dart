...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<DoctorProvider>(context, listen: false).getClinicList();
    ...
    return Scaffold(
      body: SliderMenuContainer(
          appBarColor: AllColor.appBarColor,
          key: _key,
            ...
            onItemClick: (title) {
              ...
              setState(() {
                ...
                if (title == "HOME") {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => DoctorTypeShow()),
                  );
                      ...
                      children: [
                        ...
                        SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              for (int i = 0;
                                  i < docProvider.allDoctorModelList.length;
                                  i++)
                                Card(
                        ...
                        SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              for (int i = 0;
                                  i < docProvider.allClinicList.length;
                                  i++)
                                Card(
                                  color: AllColor.backgroundColor,
                                  margin: EdgeInsets.only(top: 10, right: 15),
